...
void dma::main() {
	if (state.dicr & 0x08000000) { run_channel(6); }
	if (state.dicr & 0x00800000) { run_channel(5); }
	if (state.dicr & 0x00080000) { run_channel(4); }
	if (state.dicr & 0x00008000) { run_channel(3); }
	if (state.dicr & 0x00000800) { run_channel(2); }
	if (state.dicr & 0x00000080) { run_channel(1); }
	if (state.dicr & 0x00000008) { run_channel(0); }
}
