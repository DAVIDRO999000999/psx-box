...
//New uint32_t with the assigned function of gpu::data
uint32_t gpu::data() {
...
//Another uint32_t with the assigned function of gpu::stat
uint32_t gpu::stat() {
...
//ANOTHER uint32_t with the assigned function of gpu::bus_read
...
//New uint16_t with the assigned action of gpu::vram_transfer()
...
//New gpu::vram_transfer function
